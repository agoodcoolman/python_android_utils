...
import gametouch
def click(x,y):
    if gametouch.personMoverighting | gametouch.personMovelefting | gametouch.personMoveuping | gametouch.personMovedowning:
        ...
        os.system("adb -s " + touch.device + " shell sendevent " + touch.eventfile + " 3 57 1")  # ABS_MT_TRACKING_ID 同时点击,同时触摸,这里要设置为1,相当于多点触控中的点2
